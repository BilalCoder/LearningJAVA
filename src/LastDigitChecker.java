...
public class LastDigitChecker {
    public static void main(String[] args) {
        ...
        System.out.println(hasSameLastDigit(23, 12 ,113));
        System.out.println(hasSameLastDigit(-1, 212 ,123));
        System.out.println(hasSameLastDigit(78, 12 ,32));
        System.out.println(hasSameLastDigit(89, 36 ,123));
    }
