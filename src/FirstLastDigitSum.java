...
public class FirstLastDigitSum {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sumFirstAndLastDigit(90091));
        System.out.println(sumFirstAndLastDigit(84736));
    }
...
//    }
    ...
    // A better and concise solution
    public static int sumFirstAndLastDigit(int number) {
        if (number < 0)
            return -1;
        int lastDigit = number % 10;
        // while number is double digit
        while (number > 9) {
            number /= 10;
        }
